export const zh = {
  ...
  'auth.newPasswordTooShort': '密碼至少 8 個字元',
  ...
  'auth.nameTaken': '這個名字已經有人使用了，請換一個，或直接登入',
} as const;
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'auth.newPasswordTooShort': 'The password must be at least 8 characters',
  ...
  'auth.nameTaken': 'That name is already taken — pick another, or sign in',
};
...
export const ja: Record<keyof typeof zh, string> = {
  ...
  'auth.newPasswordTooShort': 'パスワードは8文字以上にしてください',
  ...
  'auth.nameTaken': 'この名前はすでに使われています。別の名前にするか、ログインしてください',
};
